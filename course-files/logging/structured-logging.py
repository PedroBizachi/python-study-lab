...
extra_context = {
    "conetext_data": {
        "user_id": "devops1",
        "request_id": "request_1234abc",
        "source_ip": "10.0.0.5",
    }
}

json_logger.warning("Request took longer than 5s to complete", extra=extra_context)
...
try:
    ...
    json_logger.exception(
        "Unexpected calculation error", extra={"operation": "division"}
    )
