...
# process_hostnames(open_ports) # Uncommenting will raise a TypeError
...
server_status: tuple[str, int, bool] = ("api.example.com", 443, True)
...
def find_user(user_id: str) -> Optional[dict[str, str]]:
    if user_id == "123":
        return {"id": "123", "name": "Admin user", "email": "admin@example.com"}
