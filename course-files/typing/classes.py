...
def deploy_app_to_server(target_server: Server, app_name: str) -> bool:
    ...
    print(f"Deployment of {app_name} to {target_server.hostname} successfull.")
    return True
...
class Calculator:
    ...
    def substract(self, value: int | float) -> Self:
        self.total -= value
...
print(my_calc.add(2).substract(1).multiply_by(10).get_total())
